...
SECRET_KEY = 'django-insecure-@y+lpl^41zmcx_7khyw*@tbm1@q7+^3*&bqxhsyjvh^fa=+tws'
...
INSTALLED_APPS = [
    ...
    # USE THE FULL PATH TO THE APP CONFIG CLASS FOR NESTED APPS
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates/relationship_app'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
