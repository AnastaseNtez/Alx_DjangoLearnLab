...
class Post(models.Model):
    ...
    # on_delete=models.CASCADE ensures that if a User is deleted, all their associated 
    # posts are also deleted. This is the "multiple posts by a single author" relation.
    ...
    # Optional: Define metadata for the model
    class Meta:
