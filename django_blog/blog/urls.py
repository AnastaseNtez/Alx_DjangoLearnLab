...
urlpatterns = [
    ...
    path('post/<int:post_id>comments/update/', views.CommentUpdateView.as_view(), name='comment-update'),
    
    # Delete Comment (Uses the Comment's PK)
    path('post/<int:post_id>/comments/delete/', views.CommentDeleteView.as_view(), name='comment-delete'),
]